/*! pb-gest-product 0.1.0 - Copyright 2015 Palmabit <hello@palmabit.com> (http://www.palmabit.com) */
'use strict';
...
var ProductPresenter = (function () {
  ...
  _createClass(ProductPresenter, [{
    ...
    key: 'calculatePrice',
    value: function calculatePrice(product) {
      var i,
          user = this.user,
    ...
    key: 'calculateQty',
    value: function calculateQty(product) {
